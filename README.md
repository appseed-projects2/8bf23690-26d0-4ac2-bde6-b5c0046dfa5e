...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-14 13:14`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/8bf23690-26d0-4ac2-bde6-b5c0046dfa5e.git
$ cd 8bf23690-26d0-4ac2-bde6-b5c0046dfa5e
```
